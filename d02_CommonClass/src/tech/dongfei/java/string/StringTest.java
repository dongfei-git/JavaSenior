 ...
 * replacement 替换此字符串匹配给定的正则表达式的第一个子字符串。  boolean matches(String regex)：告知此字符串是否匹配给定的正则表达式。  String[] split(String regex)：根据给定正则表达式的匹配拆分此字符串。  String[] split(String regex, int limit)：根据匹配给定的正则表达式来拆分此
...
public class StringTest {
    ...
    public void test1(){
        ...
        System.out.println("   he  llo  world".trim());  //去掉头尾的空格
    }
    ...
    public void test2(){
        ...
        System.out.println(s1.concat("World"));  //字符串拼接

        String s3 = "HelloWorld";
        System.out.println(s3.substring(2,4)); //截取子串
    }
    ...
    public void test4(){
        ...
        String replace = str1.replace("world", "java");
        System.out.println(replace);
    }

    @Test
    public void test5(){
        String str1 = "hell world java";
